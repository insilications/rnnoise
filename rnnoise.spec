...
Version  : 12.3.2021
Release  : 314
URL      : file:///aot/build/clearlinux/packages/rnnoise/rnnoise-v12.3.2021.tar.gz
Source0  : file:///aot/build/clearlinux/packages/rnnoise/rnnoise-v12.3.2021.tar.gz
Source1  : file:///aot/build/clearlinux/packages/rnnoise/car.tar.gz
Summary  : RNN-based noise suppression
Group    : Development/Tools
License  : GPL-2.0
Requires: rnnoise-lib = %{version}-%{release}
...
%package dev
Summary: dev components for the rnnoise package.
Group: Development
Requires: rnnoise-lib = %{version}-%{release}
Provides: rnnoise-devel = %{version}-%{release}
Requires: rnnoise = %{version}-%{release}

%description dev
dev components for the rnnoise package.


%package doc
Summary: doc components for the rnnoise package.
Group: Documentation

%description doc
doc components for the rnnoise package.


%package lib
Summary: lib components for the rnnoise package.
Group: Libraries

%description lib
lib components for the rnnoise package.


%package staticdev
Summary: staticdev components for the rnnoise package.
Group: Default
Requires: rnnoise-dev = %{version}-%{release}

%description staticdev
staticdev components for the rnnoise package.
...
cd %{_builddir}/rnnoise
mkdir -p sample
cp -a %{_builddir}/car.tar/* %{_builddir}/rnnoise/sample
pushd %{_builddir}
cp -a %{_builddir}/rnnoise build-special
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640831414
...
pushd examples/
./rnnoise_demo /builddir/build/BUILD/rnnoise/sample/otter.pcm /builddir/build/BUILD/rnnoise/sample/otter_d.pcm
popd
export LD_LIBRARY_PATH="/usr/nvidia/lib64:/usr/nvidia/lib64/gbm:/usr/nvidia/lib64/vdpau:/usr/nvidia/lib64/xorg/modules/drivers:/usr/nvidia/lib64/xorg/modules/extensions:/usr/local/cuda/lib64:/usr/lib64/haswell:/usr/lib64/dri:/usr/lib64:/usr/lib:/aot/intel/oneapi/compiler/latest/linux/compiler/lib/intel64_lin:/aot/intel/oneapi/compiler/latest/linux/lib:/aot/intel/oneapi/mkl/latest/lib/intel64:/aot/intel/oneapi/tbb/latest/lib/intel64/gcc4.8:/usr/share:/usr/lib64/wine:/usr/nvidia/lib32:/usr/nvidia/lib32/vdpau:/usr/lib32:/usr/lib32/wine"
export LIBRARY_PATH="/usr/nvidia/lib64:/usr/nvidia/lib64/gbm:/usr/nvidia/lib64/vdpau:/usr/nvidia/lib64/xorg/modules/drivers:/usr/nvidia/lib64/xorg/modules/extensions:/usr/local/cuda/lib64:/usr/lib64/haswell:/usr/lib64/dri:/usr/lib64:/usr/lib:/aot/intel/oneapi/compiler/latest/linux/compiler/lib/intel64_lin:/aot/intel/oneapi/compiler/latest/linux/lib:/aot/intel/oneapi/mkl/latest/lib/intel64:/aot/intel/oneapi/tbb/latest/lib/intel64/gcc4.8:/usr/share:/usr/lib64/wine:/usr/nvidia/lib32:/usr/nvidia/lib32/vdpau:/usr/lib32:/usr/lib32/wine"
## profile_payload end
